...
- **Research-eligibility quarantine PROPOSED 2026-08-19 (PA-0002; data-spec
  ...
  (77/30), coverage still 516, 8 roll switches unchanged. **PA-0002 was
  APPROVED 2026-08-20 (AL-0060) and DEV/SELECTION are now ACTIVE (AL-0067) —
  see the activation bullet below; HOLDOUT stays sealed.**
- Remaining open items: the 10 PENDING_EVIDENCE calendar dates (PA-0001,
  data-spec §6c); PA-0002 review and partition activation are COMPLETE
  (AL-0060/AL-0064/AL-0067);
